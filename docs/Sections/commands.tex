...
\begin{table}[h!]
    \begin{center}
        ...
        \hyperref[sec:message:close]{get\_history} & Gets the edit history of a spreadsheet \\\hline
        \hyperref[sec:message:close]{get\_spreadsheet} & Gets the contents of a spreadsheet \\\hline
        \hyperref[sec:message:close]{push} & Pushes edits to be applied to the spreadsheet \\\hline
        \hyperref[sec:message:close]{undo} & Undoes the most recent edit of a spreadsheet \\\hline
        \end{tabular}
    \end{center}
\end{table}

\lstset{language=json,frame=single,numbers=none}
